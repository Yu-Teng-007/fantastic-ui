<template>
    <view class="container">
        ...
        <view class="page-section">
            ...
            <view class="section-content">
                <view class="example-block">
                    ...
                    <view class="result-display"> 已选中：{{ groupResult1.join(", ") }} </view>
                </view>
            </view>
        </view>
        ...
        <view class="page-section">
            ...
            <view class="section-content">
                <view class="example-block">
                    <fanc-checkbox-group v-model="groupResult3" :max="2" @exceed-max="onExceedMax">
        ...
        <view class="page-section">
            ...
            <view class="section-content">
                <view class="example-block">
                    ...
                    <view class="result-display"> 已选中：{{ customIcons.join(", ") }} </view>
                </view>
            </view>
        </view>
