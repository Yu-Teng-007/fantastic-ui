<template>
    <view class="container">
        <view class="header">
            ...
            <view class="subtitle">在一组备选项中进行单选</view>
        </view>
...
export default {
    ...
    data() {
        return {
            ...
            // 不同选中样式
            checkTypeChecked1: true,
            checkTypeChecked2: true,
            ...
            // 单选框组选中样式
            groupCheckTypeValue: "b",

            // 单选框组形状
            groupShapeValue: "b",

            // 禁用状态
            groupDisabledValue: "b",

            // 垂直排列
            groupVerticalValue: "c",

            // 单选框组混合形状
            groupMixedShapeValue: "a",
        };
    },
};
</script>
