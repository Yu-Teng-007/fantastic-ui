<template>
    <view class="example-page">
        ...
        <view class="example-page__section">
            ...
            >
            <fanc-cell label="单元格" content="内容" icon="home" />
            <fanc-cell label="单元格">
                <template #icon>
                    <fanc-icon name="user" style="color: #1989fa" size="16" />
                </template>
            </fanc-cell>
        </view>
        ...
        <view class="example-page__section">
            ...
            >
            <fanc-cell label="单元格" is-link />
            <fanc-cell label="单元格" is-link content="内容" />
            <fanc-cell label="单元格" is-link arrow-direction="down" content="内容" />
        </view>

        <view class="example-page__section">
            <view class="example-page__section-title">页面导航</view>
            <view class="example-page__section-desc">可以通过 url 或 to 属性进行页面跳转</view>
            <fanc-cell label="URL 跳转" is-link url="/pages/index/index" />
            <fanc-cell label="路由跳转" is-link to="/pages/index/index" />
        </view>
        ...
        <view class="example-page__section">
            ...
            <fanc-cell label="单元格" is-link>
                <template #right-icon>
                    <fanc-icon name="settings" class="custom-icon" />
                </template>
            </fanc-cell>
        </view>
