<template>
    <view class="page">
        ...
        <view class="page__content">
            <fanc-form :model="formData" :rules="rules" label-position="top" ref="form">
                <!-- 用户基本信息 -->
                    ...
                    <fanc-form-item label="性别" prop="gender">
                        <view class="radio-group">
                            <view class="radio-item" @click="formData.gender = 'male'">
                                <view
                                    class="radio-button"
                                    :class="{ 'radio-button--active': formData.gender === 'male' }"
                                ></view>
                                <text>男</text>
                            </view>
                            <view class="radio-item" @click="formData.gender = 'female'">
                                <view
                                    class="radio-button"
                                    :class="{
                                        'radio-button--active': formData.gender === 'female',
                                    }"
                                ></view>
                                <text>女</text>
                            </view>
                ...
                <view class="form-actions">
                    ...
                    <fanc-button block @click="resetForm" style="margin-top: 10px"
                        >重置表单</fanc-button
                    >
                </view>
            </fanc-form>
...
export default {
    ...
    methods: {
        ...
        confirmStartDate() {
            ...
            this.formData.startDate = `${year}-${month.toString().padStart(2, "0")}-${day
                .toString()
                .padStart(2, "0")}`;
        ...
        confirmEndDate() {
            ...
            this.formData.endDate = `${year}-${month.toString().padStart(2, "0")}-${day
                .toString()
                .padStart(2, "0")}`;
